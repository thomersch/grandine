...
[![Build Status on Travis-CI.](https://travis-ci.org/ctessum/polyclip-go.svg?branch=master)](https://travis-ci.org/ctessum/polyclip-go)
![License: MIT.](https://img.shields.io/badge/license-MIT-orange.svg)
[![Documentation on godoc.org.](https://godoc.org/github.com/ctessum/polyclip-go?status.svg)](https://godoc.org/github.com/ctessum/polyclip-go)
...
Simplest Go program using polyclip-go for calculating intersection of a square and triangle:
    ...
    import (
        "fmt"
        "github.com/ctessum/polyclip-go" // or: bitbucket.org/...
    )
...
To compile and run the program above, execute the usual sequence of commands:
    ...
    go get github.com/ctessum/polyclip-go  # or: bitbucket.org/...
    go build example.go
    ./example      # Windows: example.exe

For full package documentation, run locally `godoc github.com/ctessum/polyclip-go`, or visit [online documentation for polyclip-go][godoc].

  [godoc]: http://godoc.org/github.com/ctessum/polyclip-go
